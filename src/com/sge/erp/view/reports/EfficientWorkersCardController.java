...
public class EfficientWorkersCardController {
    ...
    @FXML
    private Label lTaskCompleted;

    public Label getlTaskCompleted() {
        return lTaskCompleted;
    }

    public void setlTaskCompleted(Label lTaskCompleted) {
        this.lTaskCompleted = lTaskCompleted;
    }
